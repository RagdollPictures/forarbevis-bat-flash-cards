...
export const bonusSymboler: FlashCard[] = [
  ...
  },
  {
    ...
    textTitle: "Vrak",
    textInfo:
      "Markerar ett sjunket fartyg. Ej farligt för ytnavigering."
  },
  {
    id: "bonus_symboler-5",
    question: "",
    ...
    textInfo:
      "Visar en sten under vattenytan, farlig för ytnavigering."
  },
  {
    id: "bonus_symboler-6",
    question: "",
  ...
  },
  {
    ...
    questionQuiz: "Vad betyder denna symbol i sjökortet?",
    answer: "",
    options: ["Ankringsområde", "Varningsmärke", "Ankring förbjuden", "Vrak"],
    correctOptionIndex: 0,
