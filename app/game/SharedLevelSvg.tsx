...
const SharedLevelSvg = (props: SharedLevelSvgProps) => (
  <Svg viewBox="0 0 375 5200" {...props}>
    <G id="anchor_bg">
      <Path d="M0 0h375v5200H0z" />
    </G>
    <G id="level_001" display={isVisible("level_001", props.visibleLayerIds) ? "flex" : "none"}>
      <Path
        fill={props.layerColors?.["level_001"] ?? "#fcfcd8"}
        d="M65.43 93.409h95.697s5.94-12.21-13.2-15.51-1.98-16.17-27.39-16.5-3.63 11.22-27.389 14.52-2.97 5.61-32.339 9.9-26.07 8.58-26.07 8.58z"
      />
      <Circle
        cx={168.953}
        cy={49.223}
      ...
      <Path
        ...
        d="M34.74 94.399s23.18-3.202 62.618-8.249c44.798-5.733 66.113-1.168 63.769 7.259s-12.045 3.415-64.59 3.004S34.74 94.4 34.74 94.4"
      />
      <Path
        fill={props.layerColors?.["level_001"] ?? "#9e9514"}
        d="M126.198 242.21c11.03-7.546 124.819-28.446 156.75 85.923s-60.378 104.5-49.348 140.493c11.03 35.995 114.95 50.508 124.819 108.564s-39.478 98.693-109.725 110.885-154.427 1.161-163.135-52.83 96.952-103.339 83.6-149.202S77.43 445.404 66.98 358.902s48.186-109.144 59.217-116.691"
      />
      <Path
    ...
    <G id="book">
      <G>
        <Circle
          ...
          cy={369.529}
          r={52.836}
          fill={props.layerColors?.["book"] ?? "#231f20"}
          opacity={0.3}
        />
        <Circle
          cx={171.526}
        ...
        <Circle
          ...
          cy={351.24}
          r={52.836}
          fill={props.layerColors?.["book"] ?? "#f68a88"}
        />
        <Circle
          cx={171.526}
          cy={351.24}
      ...
      <G>
        <Circle cx={231.148} cy={597.229} r={52.836} fill="#233f56" />
        <Circle cx={231.148} cy={588.941} r={52.836} fill="#41a2b4" />
        <Circle cx={231.148} cy={588.941} r={47.343} fill="#4db0b5" />
      </G>
      <G>
        <Path
          fill="#ba5357"
          d="m176.923 332.531-3.385 2.177a3 3 0 0 1-3.374-.088l-2.659-1.912a3 3 0 0 0-1.774-.565l-20.8 2.154a3 3 0 0 0-2.978 3v33.315a3 3 0 0 0 3 3l20.794-2a3 3 0 0 1 1.747.56l2.675 1.915a3 3 0 0 0 3.364.088l3.402-2.179a3 3 0 0 1 1.618-.473l20.26 2a3 3 0 0 0 3-3v-33.315a3 3 0 0 0-2.978-3l-20.267-2.154a3 3 0 0 0-1.645.477Z"
        />
        <Path
          fill="#fcfcd8"
          d="m176.666 326.456-3.384 2.177a3 3 0 0 1-3.374-.088l-2.659-1.912a3 3 0 0 0-1.774-.565l-14.8 2.154a3 3 0 0 0-2.978 3v33.315a3 3 0 0 0 3 3l14.794-2a3 3 0 0 1 1.746.56l2.675 1.916a3 3 0 0 0 3.365.087l3.402-2.179c.483-.309 15.877 1.527 15.877 1.527a3 3 0 0 0 3-3v-33.315a3 3 0 0 0-2.977-3s-15.422-1.992-15.912-1.677Z"
        />
        <Path
          fill="#f68a88"
          d="M173.282 328.633a3 3 0 0 1-3.374-.088l.004 39.468a3 3 0 0 0 3.365.087z"
        />
      </G>
    </G>
    <G id="Layer_47" data-name="Layer 47">
      <G>
        <Path
          fill={props.layerColors?.["Layer_47"] ?? "#233f56"}
          d="m236.06 571.46-3.384 2.177a3 3 0 0 1-3.374-.088l-2.659-1.912a3 3 0 0 0-1.773-.565l-20.8 2.154a3 3 0 0 0-2.979 3v33.315a3 3 0 0 0 3 3l20.794-2a3 3 0 0 1 1.747.56l2.675 1.916a3 3 0 0 0 3.364.087l3.402-2.178a3 3 0 0 1 1.618-.474l20.26 2a3 3 0 0 0 3-3v-33.315a3 3 0 0 0-2.977-3l-20.268-2.154a3 3 0 0 0-1.645.477Z"
        />
        <Path
          fill={props.layerColors?.["Layer_47"] ?? "#fcfcd8"}
          d="m235.804 565.385-3.384 2.176a3 3 0 0 1-3.374-.087l-2.659-1.912a3 3 0 0 0-1.774-.565l-14.8 2.154a3 3 0 0 0-2.978 3v33.315a3 3 0 0 0 3 3l14.794-2a3 3 0 0 1 1.746.56l2.675 1.915a3 3 0 0 0 3.365.088l3.402-2.179c.483-.309 15.877 1.527 15.877 1.527a3 3 0 0 0 3-3v-33.315a3 3 0 0 0-2.977-3s-15.422-1.993-15.912-1.677Z"
        />
        <Path
          fill={props.layerColors?.["Layer_47"] ?? "#4db0b5"}
          d="M232.42 567.561a3 3 0 0 1-3.374-.087l.004 39.467a3 3 0 0 0 3.365.088z"
          opacity={0.2}
        />
      </G>
    </G>
